...
export default function SeguimientoTerapeuticoGrupalAdolescentesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setSaving(true)
      await saveOrUpdateFormulario(jovenId, 'seguimiento_terapeutico_grupal_adolescentes_cpi', formData)
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="text-center flex-1">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
              FICHA DE SEGUIMIENTO TERAPÉUTICO GRUPAL CPI ADOLESCENTES Y JÓVENES
            </h1>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="card">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  Actitud y grado de implicación de el/la adolescente o joven:
                </label>
                <textarea
