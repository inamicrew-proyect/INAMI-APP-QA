...
export default function InformeSocialEvaluacionSeguimientoPage() {
  ...
  const { atencionIdEdicion, loadingExisting, fichaEncontrada } = useFormularioAtencionEdicion<FormData>({
    tipoFormulario: 'informe_social_evaluacion_seguimiento',
    setFormData,
  })
    ...
    try {
      ...
      const { data: nuevaAtencion, error: atencionError } = await supabase
        ...
        .insert({
          ...
          motivo: 'Informe Social de Evaluación y Seguimiento',
          estado: 'completada'
        })
        .select()
        .single()
      ...
      const { error: insertError } = await supabase
        ...
        .insert({
          tipo_formulario: 'informe_social_evaluacion_seguimiento',
          joven_id: formData.joven_id,
      ...
      alert('Informe Social de Evaluación y Seguimiento guardado exitosamente')
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
            Informe Social de Evaluación y Seguimiento
          </h1>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6 text-center border-2 border-gray-300 dark:border-gray-700">
        ...
        <h5 className="text-lg font-bold mt-2">ÁREA DE TRABAJO SOCIAL</h5>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <p className="text-xs text-gray-600 dark:text-gray-400 mb-4">
            Detallar situación individual de NNAJ
          </p>
          <textarea
            value={formData.situacion_individual}
            onChange={(e) => setFormData(prev => ({ ...prev, situacion_individual: e.target.value }))}
            rows={8}
            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
            placeholder="Describa la situación individual del NNAJ"
          />
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <p className="text-xs text-gray-600 dark:text-gray-400 mb-4">
            Detallar situación familiar de NNAJ
          </p>
          <textarea
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <p className="text-xs text-gray-600 dark:text-gray-400 mb-4">
            Detallar situación comunitaria de NNAJ
          </p>
          <textarea
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <p className="text-xs text-gray-600 dark:text-gray-400 mb-4">
            Detallar actitud del cumplimiento de la medida de NNAJ (Valoración del técnico responsable)
          </p>
          <textarea
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            Adjuntar documentación soporte sobre el cumplimiento de la medida (Hojas de servicio comunitario, Visitas Domiciliarias, Fotografías, etc.)
          </p>
          <textarea
