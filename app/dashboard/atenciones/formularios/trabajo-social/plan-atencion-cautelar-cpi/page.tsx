...
export default function PlanAtencionCautelarCPIPage() {
    ...
    try {
      ...
      const { data: nuevaAtencion, error: atencionError } = await supabase
        ...
        .insert({
          ...
          motivo: 'Plan de Atención Cautelar (PLAC)',
          estado: 'completada'
        })
        .select()
        .single()
      ...
      const { error: insertError } = await supabase
        ...
        .insert({
          tipo_formulario: 'plan_atencion_cautelar_cpi',
          joven_id: formData.joven_id,
      ...
      alert('Plan de Atención Cautelar (PLAC) guardado exitosamente')
      router.push('/dashboard/atenciones')
    } catch (error: any) {
      console.error('Error saving form:', error)
      alert(`Error al guardar el PLAC: ${error.message || 'Error desconocido'}`)
    } finally {
      setSaving(false)
    }
  }
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
            Plan de Atención Cautelar (PLAC)
          </h1>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6 text-center border-2 border-gray-300 dark:border-gray-700">
        ...
        <h4 className="text-lg font-bold mt-4">PLAN DE ATENCIÓN CAUTELAR (PLAC)</h4>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">3.4 Presunta Infracción Cometida</label>
              <input type="text" value={formData.presunta_infraccion} onChange={(e) => setFormData(prev => ({ ...prev, presunta_infraccion: e.target.value }))} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" />
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">3.5 Tipo de Medida</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">3.7 Fecha de inicio de la medida</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">3.8 Fecha de previsión de finalización de la medida</label>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <div className="space-y-4 mb-6">
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-md">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300 mt-2">
                En la elaboración del PLAC, se ha contado con la activa participación de el/la adolescente y con la participación de su madre, padre o encargado/s como responsable/s.
              </p>
            </div>
          ...
          <div className="mb-4">
            ...
            <div className="mt-4 text-sm text-gray-600 dark:text-gray-400">
              ...
              <p className="mb-2">Se realizará una evaluación técnica interdisciplinar de seguimiento del plan, previa emisión de los informes de evaluación y seguimiento del mismo, que se emitirán en función de los avances, limitaciones, incidencias, etc., que surjan en relación a el/la adolescente y/o al cumplimiento del plan.</p>
              <p>Este Plan de Atención Cautelar (PLAC) se implementará hasta el momento en el que el/la adolescente reciba una sentencia judicial, pudiendo a partir de entonces, realizar una propuesta de continuidad del mismo a las autoridades judiciales oportunas. El PLAC estará supervisado por el Equipo Técnico asignado del Centro, al mismo tiempo se encargará de la ejecución de las tareas e informará de los avances de el/la adolescente durante su tiempo de internamiento.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <div className="mb-4">
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Al momento de la socialización del PLAC se encontraba el/la adolescente y sus responsables legales, por quienes este documento ha sido firmado en muestra de su acuerdo con el mismo.
            </p>
          </div>
          ...
          <div className="mt-6">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              Nombre, Firma y sello de el/la Directora/a del CPI
            </label>
