...
interface FormData {
  ...
  // DATOS LEGALES
  fecha_ingreso: string
  fecha_vinculacion_proceso: string
  ...
  ha_recibido_apoyo_familia: boolean
  quienes_apoyo: string
  tipo_apoyo: string
  familiares_consumen: boolean
  quien_familia_consume: string
  tiene_tatuajes: boolean
  detalle_tatuajes: string
  ...
  recomendaciones_platin: string
  
  // FUENTES DE REFERENCIA
  entrevista_social: boolean
  observacion: boolean
  expediente_administrativo_ref: boolean
  datos_medicos: boolean
  datos_educativos: boolean
}
...
export default function FichaSocialFaseDiagnosticoPage() {
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    explica_tratamiento: '',
    ha_recibido_apoyo_familia: false,
    quienes_apoyo: '',
    tipo_apoyo: '',
    ...
    diagnostico_social: '',
    pronostico_social: '',
    recomendaciones_platin: '',
    entrevista_social: false,
    observacion: false,
    ...
    try {
      ...
      const { data: nuevaAtencion, error: atencionError } = await supabase
        ...
        .insert({
          ...
          motivo: 'Ficha Social Fase de Diagnóstico',
          estado: 'completada'
        })
        .select()
        .single()
      ...
      const { error: insertError } = await supabase
        ...
        .insert({
          tipo_formulario: 'ficha_social_fase_diagnostico',
          joven_id: formData.joven_id,
      ...
      alert('Ficha Social Fase de Diagnóstico guardada exitosamente')
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
            Ficha Social Fase de Diagnóstico
          </h1>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Teléfono fijo</label>
              <input type="text" value={formData.telefono_fijo} onChange={(e) => setFormData(prev => ({ ...prev, telefono_fijo: e.target.value }))} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" />
            </div>
            <div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Correo E.</label>
              <input type="email" value={formData.correo_electronico} onChange={(e) => setFormData(prev => ({ ...prev, correo_electronico: e.target.value }))} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nombre del conyugue</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Teléfono (conyugue)</label>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Fecha de vinculación al proceso</label>
              <input type="date" value={formData.fecha_vinculacion_proceso} onChange={(e) => setFormData(prev => ({ ...prev, fecha_vinculacion_proceso: e.target.value }))} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" />
            </div>
            <div>
        ...
        {/* DIAGNÓSTICO SOCIAL */}
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">X. DIAGNÓSTICO SOCIAL (Resaltar factores protectores y factores de riesgo)</h3>
          <textarea value={formData.diagnostico_social} onChange={(e) => setFormData(prev => ({ ...prev, diagnostico_social: e.target.value }))} rows={8} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" />
        </div>

        {/* PRONÓSTICO SOCIAL */}
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">XI. PRONÓSTICO SOCIAL</h3>
          <textarea value={formData.pronostico_social} onChange={(e) => setFormData(prev => ({ ...prev, pronostico_social: e.target.value }))} rows={6} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" />
        </div>

        {/* RECOMENDACIONES PARA EL PLAN DE ATENCION INDIVIDUAL (PLATIN) */}
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">XII. RECOMENDACIONES PARA EL PLAN DE ATENCION INDIVIDUAL (PLATIN)</h3>
          <textarea value={formData.recomendaciones_platin} onChange={(e) => setFormData(prev => ({ ...prev, recomendaciones_platin: e.target.value }))} rows={8} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" />
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" checked={formData.entrevista_social} onChange={(e) => setFormData(prev => ({ ...prev, entrevista_social: e.target.checked }))} className="w-4 h-4" />
              <span>Entrevista Social</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" checked={formData.observacion} onChange={(e) => setFormData(prev => ({ ...prev, observacion: e.target.checked }))} className="w-4 h-4" />
              <span>Observación</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" checked={formData.expediente_administrativo_ref} onChange={(e) => setFormData(prev => ({ ...prev, expediente_administrativo_ref: e.target.checked }))} className="w-4 h-4" />
              <span>Expediente Administrativo</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" checked={formData.datos_medicos} onChange={(e) => setFormData(prev => ({ ...prev, datos_medicos: e.target.checked }))} className="w-4 h-4" />
              <span>Datos Médicos</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" checked={formData.datos_educativos} onChange={(e) => setFormData(prev => ({ ...prev, datos_educativos: e.target.checked }))} className="w-4 h-4" />
              <span>Datos Educativos</span>
            </label>
          </div>
        </div>
