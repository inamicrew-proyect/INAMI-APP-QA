...
export default function InformeSeguimientoPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    // II. Síntesis de Valoración Técnica
    sintesis_valoracion_tecnica: '',
    
    // III. Desarrollo de la Intervención
    desarrollo_intervencion: '',
    
    // IV. Avances obtenidos
    avances_obtenidos: '',
  ...
  const loadData = async () => {
    try {
      ...
      const formularioExistente = await getUltimoFormulario(
        jovenId,
        TIPOS_FORMULARIOS.INFORME_SEGUIMIENTO_PMSPL
      )
      ...
      <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="text-center flex-1">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
              INFORME PSICOLÓGICO DE SEGUIMIENTO
            </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="card bg-blue-50 dark:bg-blue-900/20">
            ...
            <textarea
              name="sintesis_valoracion_tecnica"
              value={formData.sintesis_valoracion_tecnica}
              onChange={handleChange}
              className="input-field"
              rows={10}
              placeholder="Describa la síntesis de la valoración técnica..."
            />
          </div>
          ...
          <div className="card bg-blue-50 dark:bg-blue-900/20">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4 italic">
              Ejemplo: Descripción de las actividades realizadas desde el ingreso o última entrevista de seguimiento.
            </p>
            <textarea
          ...
          <div className="card bg-blue-50 dark:bg-blue-900/20">
            ...
            <textarea
              name="avances_obtenidos"
              value={formData.avances_obtenidos}
              onChange={handleChange}
              className="input-field"
              rows={10}
              placeholder="Describa los avances obtenidos..."
            />
          </div>
