...
export default function SeguimientoTerapeuticoFamiliarPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    // Other observations and next session
    otras_observaciones: '',
    proxima_sesion: '',
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="text-center flex-1">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
              FICHA DE SEGUIMIENTO TERAPÉUTICO FAMILIAR CPI
            </h1>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="input-field"
                  placeholder="Ej: Terapia familiar, Individual, Grupal"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="input-field"
                  rows={3}
                  placeholder="Liste los asistentes a la sesión..."
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  Actitud y grado de implicación de cada uno/a de los miembros de la familia
                </label>
                <textarea
          ...
          <div className="card">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  Otras observaciones: (estados anímicos, aspecto físico, comunicación no verbal, etc).
                </label>
                <textarea
